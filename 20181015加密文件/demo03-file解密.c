...
int FileSymDes(const char *pfile1, const char *pfile2)
{
...
{
	int ret = 0;
	const char *pfile1 = "d:/2.enc.txt";
	const char *pfile2 = "d:/3.cer";
	ret = FileSymDes(pfile1, pfile2);
	if (ret != 0)
	{
		printf("enc error\n");
	}
